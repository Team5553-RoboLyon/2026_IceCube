...
enum class ControlMode {
    ...
    VELOCITY_MODEL_CONTROLLED,  // Velocity control using a dynamic system model (feedforward + PID feedback)
    ...
    FEEDFORWARD_VELOCITY_VOLTAGE,   // Open-loop velocity control (kS/kV/kA model, output in volts)
    FEEDFORWARD_VELOCITY_DUTYCYCLE, // Open-loop velocity control (kS/kV/kA model, duty cycle output)
    ...
    MANUAL_CURRENT,                 // Manual current command
    MANUAL_TORQUE,                  // Manual torque command
...
#define ALLOWS_STATE_MACHINE(mode) ((mode) == ControlMode::PROFILED_PID || \
                                    ...
                                    (mode) == ControlMode::VELOCITY_MODEL_CONTROLLED || \
                                    ...
                                    (mode) == ControlMode::FEEDFORWARD_VELOCITY_DUTYCYCLE || \
                                    (mode) == ControlMode::FEEDFORWARD_VELOCITY_VOLTAGE || \
...
#define BYPASS_STATE_MACHINE(mode) ((mode) == ControlMode::MANUAL_POSITION || \
                                    ...
                                    (mode) == ControlMode::MANUAL_CURRENT || \
                                    (mode) == ControlMode::MANUAL_TORQUE || \
...
inline const char* ToString(const ControlMode mode) {
    switch (mode) {
        ...
        case ControlMode::VELOCITY_MODEL_CONTROLLED: return "VELOCITY_MODEL_CONTROLLED";
        ...
        case ControlMode::FEEDFORWARD_VELOCITY_VOLTAGE:    return "FEEDFORWARD_VELOCITY_VOLTAGE";
        case ControlMode::FEEDFORWARD_VELOCITY_DUTYCYCLE:  return "FEEDFORWARD_VELOCITY_DUTYCYCLE";
        ...
        case ControlMode::MANUAL_CURRENT:           return "MANUAL_CURRENT";
        case ControlMode::MANUAL_TORQUE:            return "MANUAL_TORQUE";
